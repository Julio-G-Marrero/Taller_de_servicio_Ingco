<div>
    <section class="py-10">
        <div class="mx-auto container max-w-2xl md:w-3/4 shadow-md">
            ...
            <form wire:submit.prevent='editarOrden'>
                <div class="bg-white space-y-6">
                        ...
                        <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                            ...
                            <div>
                                ...
                                <div class="my-5 w-80">
                                    @if($comprobanteNuevo)
                                        Nuevo Comprobante:
                                        <img src="{{$comprobanteNuevo->temporaryUrl()}}" alt="imagen servidor">
                                    @endif
                                </div>
                                @error('comprobanteNuevo')
                                    <livewire:mostrar-alerta :message="$message" />
                                @enderror
                            </div>
                            <div>
                                <label class="text-sm text-gray-400">Comprobante</label>
                                <img src="{{asset('storage/ordenes/' . $comprobante)}}" alt="img orden">
                            </div>
                            <div>
                    ...
                    <hr>
                    <div class="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                        <h2 class="md:w-1/3 mx-auto max-w-sm">Información Orden</h2>
                        <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                            <div>
                                <label for="zona_id" class="text-sm text-gray-400">Zona Asignada</label>
                                <div class="w-full inline-flex border">
                                    <div class="pt-2 w-1/12 bg-gray-100">
                                        <svg 
                                        class="w-6 text-gray-400 mx-auto"
                                    ...
                                    <select wire:model="zona_id" id="zona_id">
                                        <option value="">--Seleccione--</option>
                            ...
                            <div>
                                <label for="centro_de_servicio_id" class="text-sm text-gray-400">Centro De Servicio</label>
                                <div class="w-full inline-flex border">
                                    <div class="pt-2 w-1/12 bg-gray-100">
                                        <svg 
                                        class="w-6 text-gray-400 mx-auto"
                                    ...
                                    <select wire:model="centro_de_servicio_id" id="centro_de_servicio_id">
                                        <option value="">--Seleccione--</option>
                                        @foreach ($all_centro_de_servicios as $all_centro_de_servicio)
                                            <option value="{{$all_centro_de_servicio->id}}">{{$all_centro_de_servicio->direccion}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('centro_de_servicio_id')
                                    <livewire:mostrar-alerta :message="$message" />
                                @enderror
                            </div>
                            <div>
                                <label for="estatu_id" class="text-sm text-gray-400">Estatus de la orden</label>
                                <div class="w-full inline-flex border">
                                    <div class="pt-2 w-1/12 bg-gray-100">
                                        <svg 
                                        class="w-6 text-gray-400 mx-auto"
                                    ...
                                    <select wire:model="estatu_id" id="estatu_id">
                                        <option value="">--Seleccione--</option>
                    ...
                    <div class="md:inline-flex justify-end space-y-4 md:space-y-0  p-4 text-gray-500 items-center">
                        <input class=" cursor-pointer text-white w-full mx-auto max-w-sm rounded-md text-center bg-amber-400 py-2 px-4 inline-flex items-center focus:outline-none md:float-right" type="submit" value="Guardar Cambios">
                    </div>
                </div>
            </form>
        </div>
