    ...
    <div class="mx-auto container max-w-2xl md:w-3/4 shadow-md">
        <div class="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-amber-400 rounded-t">
            <div class="max-w-sm mx-auto md:w-full md:mx-0">
                ...
                <h1 class="text-gray-600">Llena todo el formulario.</h1>
                </div>
            </div>
        </div>
        <form wire:submit.prevent='crearOrdenCliente'>
            <div class="bg-white space-y-6">
                ...
                <div class="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                    ...
                    <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                        ...
                        {{-- <div>
                            <label for="tienda_id" class="text-sm text-gray-400">Lugar de Expedición</label>
                            <div class="w-full inline-flex border">
                                <div class="pt-2 w-1/12 bg-gray-100">
                                    <svg 
                                    class="w-6 text-gray-400 mx-auto"
                ...
                <hr>
                <div class="hidden space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                    ...
                    <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                        ...
                        <div class="">
                            ...
                            <div class="w-full inline-flex border">
                                ...
                                <textarea wire:model="descripcion" class="w-11/12 focus:outline-none focus:text-gray-600 p-2"  id="descripcion" value="No se ah solicitado aún" cols="30" rows="10">No se ah solicitado aún.</textarea>
