            ...
            <div>
                <div class="shadow-lg rounded-lg bg-white mx-auto m-8 p-4 notification-box flex">
                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            <a href="{{route('ordenes.tracking',$notificacion->data['idOrden'])}}" class=" text-xs lg:text-sm text-center  uppercase font-semibold text-amber-600 hover:underline">Ver Orden</a>
                        </div>
                    </div>
                </div>
            </div><!-- Notificacion !-->
