...
<div class="flex items-center justify-between">
    <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Inventario</p>
...
<div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-4">
    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
       <div class="flex items-center">
          <div class="flex-shrink-0">
             ...
             <h3 class="text-base font-normal text-gray-500">Total Piezas</h3>
          </div>
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
       <div class="flex items-center">
          <div class="flex-shrink-0">
             <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">5,6</span>
             <h3 class="text-base font-normal text-gray-500">Numero de Ubicaciones</h3>
          </div>
          <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
             32.9%
             <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
       <div class="flex items-center">
          <div class="flex-shrink-0">
             <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">$15,385</span>
             <h3 class="text-base font-normal text-gray-500">Costo Total</h3>
          </div>
    ...
    <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
                ...
                <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                    <div class="sm:flex items-center justify-between">
                        <div class="flex items-center">
                            <a class="rounded-full focus:outline-none focus:ring-2   focus:ingco-color" href=" javascript:void(0)">
                                <div class="py-2 px-8 bg-ingco-color text-white rounded-full">
                                    <p>Todas</p>
                                </div>
                            </a>
                            <a class="rounded-full focus:outline-none focus:ring-2  focus:ingco-color ml-4 sm:ml-8" href="javascript:void(0)">
                                <div class="py-2 px-8 text-gray-600 hover:ingco-color hover:bg-ingco-color rounded-full ">
                                    <p>Piezas</p>
                                </div>
                            </a>
                            <a class="rounded-full focus:outline-none focus:ring-2  focus:ingco-color ml-4 sm:ml-8" href="javascript:void(0)">
                        ...
                        <a href="{{route('inventario-crear')}}">
                            <button onclick="popuphandler(true)" class="focus:ring-2 focus:ring-offset-2 focus:ring-amber-400 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-amber-500 hover:bg-amber-400 focus:outline-none rounded">
                                <p class="text-sm font-medium leading-none text-white">Agregar Pieza</p>
                            </button>
                        </a>
                    </div>
                    <div class="mt-7 overflow-x-auto">
                        <table class="w-full whitespace-nowrap">
                            <tbody>
                                ...
                                <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                                    <td  class="focus:text-amber-600 ">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 mr-2">Electrica</p>
                                        </div>
                                    </td>
                                    <td  class="focus:text-amber-600 ">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 mr-2">UCDLI20012</p>
                                        </div>
                                    </td>
                                    <td  class="focus:text-amber-600 ">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 mr-2">Carbon</p>
                                        </div>
                                    </td>
                                    <td class="pl-24">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">Nueva</p>
                                        </div>
                                    </td>
                                    <td class="pl-5">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">15 pz</p>
                                        </div>
                                    </td>
                                    <td class="pl-5">
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">3</p>
                                        </div>
                                    </td>
                                    <td class="pl-5">
                                        <div class="flex items-center">
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            ...
                                            <p class="text-sm leading-none text-gray-600 ml-2">$5,487.25</p>
                                        </div>
                                    </td>
                                    <td class="pl-5">
                                        <button class="py-3 px-6 focus:outline-none text-sm leading-none text-gray-700 bg-gray-100 rounded">Creada el 21.02.21</button>
                                    </td>
                                    <td class="pl-4">
                                    ...
                                    <td>
                                        <div class="relative px-5 pt-2">
                                            ...
                                            <div class="dropdown-content bg-white shadow w-24 absolute z-30 right-0 mr-6 hidden">
                                                <div tabindex="0" class="focus:outline-none focus:text-amber-600 text-xs w-full hover:bg-amber-700 py-4 px-4 cursor-pointer hover:text-white">
                                                    <p>Edit</p>
                                                </div>
                                                <div tabindex="0" class="focus:outline-none focus:text-amber-600 text-xs w-full hover:bg-amber-700 py-4 px-4 cursor-pointer hover:text-white">
                                                    <p>Delete</p>
                                ...
                                <tr class="h-3"></tr>                               <tr class="h-3"></tr>
                                <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                                    <td  class="focus:text-amber-600 ">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 mr-2">Electrica</p>
