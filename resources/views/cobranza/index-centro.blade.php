...
<div class="flex items-center justify-between">
    <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Cobranza</p>
    @if (session()->has('mensaje-cobranza'))
      <div class="uppercase  border-l-green-600 bg-green-100 text-green-600 font-bold p-2 my-3 text-sm">
         {{session('mensaje-cobranza')}}
      </div>
   @endif
