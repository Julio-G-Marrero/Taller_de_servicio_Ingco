...
class RegistrarHerramientaCliente extends Component
{
    ...
    public function crearOrdenCliente()
    {
        ...
        Order::create([
            ...
            'tipo_application' => 1,
            'descripcion' => 'No se ah solicitado aún.',
        ...
        //Crear mensaje
        session()->flash('mensaje','La herramienta se ah gaurdado Exitosamente');
    ...
    {
        $tiendas = Tienda::all();
        return view('livewire.registrar-herramienta-cliente',[
            'tiendas' => $tiendas
        ]);
    }
}
